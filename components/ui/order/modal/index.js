...
const createFormState = ({price, email, confirmationEmail}, hasAgreedTOS) => {
    if (!price || Number(price) <= 0) {
    ...
    else if (confirmationEmail === 0 || email.length === 0 ) {
        ...
        return(_createFormState(true, 'You need to accept terms of service in order to submit the form.'))
    }
                ...
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div className="sm:flex sm:items-start">
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            {
                                formState.message && 
                                <div className="p-4 text-red-700 bg-yellow-100 rounded-lg text-sm">
                                    {formState.message}
                                </div>
                            }
                        </div>
